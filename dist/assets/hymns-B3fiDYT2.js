import{s as p}from"./supabase-C4TjTvDq.js";import"./main-CCVxK76c.js";import{s as f}from"./page-header-Bl-XMcri.js";let s=[];async function L(){console.log("loadSongs started");try{const{data:e,error:n}=await p.from("hymns").select(`
                *,
                authors(name),
                books(name),
                categories(name)
