import{s as y}from"./supabase-C4TjTvDq.js";import"./main-4yU1RJkU.js";const r=document.getElementById("galleryGrid"),s=document.getElementById("galleryLoading"),d=document.getElementById("galleryError"),o=document.getElementById("galleryEmpty"),x=document.getElementById("galleryRetry"),l=document.getElementById("galleryLightbox"),g=document.getElementById("galleryLightboxImage"),I=document.getElementById("galleryLightboxCaption"),v=document.getElementById("galleryLightboxClose"),B=document.getElementById("galleryPrevious"),w=document.getElementById("galleryNext");let n=[],i=0;document.addEventListener("DOMContentLoaded",p);async function p(){U();try{const{data:e,error:a}=await y.from("media").select(`
                id,
                file_name,
                storage_path,
                file_type,
