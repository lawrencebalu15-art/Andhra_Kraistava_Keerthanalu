import{s as l}from"./supabase-C4TjTvDq.js";import"./main-Dw1_MU5N.js";import"./home-4Cs49zuK.js";import"./page-header-Bl-XMcri.js";const h=document.getElementById("interviewAuthors"),u=document.getElementById("interviewsGrid"),m=document.getElementById("authorHeader"),v=document.getElementById("backToAuthors"),g=document.getElementById("interviewsLoading"),f=document.getElementById("interviewsError"),L=document.getElementById("interviewsEmpty");E();async function E(){q();try{const t=new URLSearchParams(window.location.search).get("author");if(t){await B(t);return}await U()}catch(e){console.error("Failed to load interviews:",e),x()}}async function U(){const{data:e,error:t}=await l.from("interviews").select(`
            author_id
